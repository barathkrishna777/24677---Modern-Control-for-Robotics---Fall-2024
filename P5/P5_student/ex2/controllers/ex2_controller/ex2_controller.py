...
customController = AdaptiveController(driver, lossOfThust) # customController = AdaptiveController(driver, lossOfThust)
...
if type(customController).__name__ == 'AdaptiveController':
    np.save("x_ad_hist_ex2",stateHistory) # states using adatpive controller
elif type(customController).__name__ == 'LQRController':
